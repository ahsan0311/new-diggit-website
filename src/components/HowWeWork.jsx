        ...
        <div className="relative overflow-hidden">
          ...
          {steps.map((step, idx) => (
            <div
              ...
              className={`relative mt-20 mb-20 flex justify-between w-full ${
                idx % 2 === 0
                  ? "flex-row items-stretch"
                  : "flex-row-reverse items-stretch"
              } max-[853px]:flex-row max-[853px]:items-start`}
            >
              <div
                ref={(el) => (contentRef.current[idx] = el)}
                className="w-6/12 px-10 py-8 rounded-xl max-[853px]:w-full max-[853px]:text-left max-[853px]:px-8 max-[853px]:py-6 max-[853px]:ml-16 max-[853px]:mt-[-95px] max-[435px]:ml-8"
              >
                <h3 className="text-4xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-sky-500 max-[853px]:text-4xl max-[553px]:!text-2xl">
                  {step.title}
                </h3>
              ...
              <div
                ref={(el) => (iconRef.current[idx] = el)}
                className="w-4/12 mt-10 flex justify-center items-start max-[853px]:w-auto max-[853px]:ml-auto max-[853px]:mr-6 max-[853px]:justify-end max-[853px]:mt-[-70px] max-[553px]:w-[20px] max-[553px]:ml-auto max-[553px]:mr-3 max-[553px]:justify-end max-[553px]:mt-[-70px] max-[435px]:ml-[-300px]"
              >
                <div className="!text-8xl max-[853px]:!text-6xl max-[553px]:!text-4xl text-blue-300">
                  {step.icon}
                </div>
              </div>
            </div>
