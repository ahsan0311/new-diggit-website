...
const PropCard = ({ title, image }) => {
  ...
  <div className="mb-4 w-14 h-14 flex justify-center md:justify-start image-flip">
  ...
  <h2 className="text-white font-[500] font-sans text-xl sm:text-2xl md:text-2xl lg:text-2xl leading-snug break-words w-full min-h-[72px]">
    {title}
  </h2>
</div>
