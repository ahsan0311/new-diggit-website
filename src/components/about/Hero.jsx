      ...
      <div className="relative z-10  min-h-screen flex items-center justify-center px-4 sm:px-6 text-white text-center">
        <div className="max-w-4xl mt-20">
          ...
          <p className=" text-white  mb-8">
            ...
            work smarter, scale faster, and simplify complexity. From AI-powered
            systems to fully customized tools, we create business solutions that
            strengthen operations and transform the way teams achieve success.
          </p>
